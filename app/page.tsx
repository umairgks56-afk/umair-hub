    ...
    <main className="min-h-screen bg-[#f6f7fb] text-slate-950 selection:bg-slate-900 selection:text-white">
      ...
      <section className="lg:ml-[260px]">
        <header className="sticky top-0 z-30 flex h-[76px] items-center justify-between border-b border-slate-200/80 bg-white/85 px-4 backdrop-blur-xl sm:px-6 md:px-10">
          <div className="flex items-center gap-3"><button onClick={()=>setOpen(true)} className="rounded-xl border border-slate-200 bg-white p-2.5 shadow-sm lg:hidden"><Menu size={19}/></button><div><p className="hidden text-[11px] font-bold uppercase tracking-[.18em] text-slate-400 sm:block">Your study workspace</p><h1 className="mt-0.5 text-lg font-black tracking-tight sm:text-xl">Good afternoon, Umair <span className="inline-block">👋</span></h1></div></div>
        ...
        <div className="mx-auto max-w-[1440px] p-4 sm:p-6 md:p-10">
          ...
          <div className="mt-10 grid gap-5 xl:grid-cols-[1.35fr_.65fr]"><div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm sm:p-6"><div className="flex items-center justify-between"><div><h3 className="font-black">Recent workspace</h3><p className="mt-1 text-xs text-slate-400">Your latest study activity</p></div><Clock3 size={18} className="text-slate-300"/></div><div className="mt-6 rounded-xl border border-dashed border-slate-200 bg-slate-50/60 p-8 text-center"><div className="mx-auto grid size-12 place-items-center rounded-2xl bg-white shadow-sm"><BookOpen size={20}/></div><p className="mt-3 text-sm font-bold">Your courses and files will appear here</p><p className="mt-1 text-xs text-slate-400">Upload your first study material to get started.</p></div></div><div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm sm:p-6"><div className="flex items-center justify-between"><h3 className="font-black">Your progress</h3><BarChart3 size={18} className="text-slate-300"/></div><div className="mt-6 flex items-center gap-4"><div className="grid size-20 place-items-center rounded-full border-8 border-slate-950 text-lg font-black">0%</div><div><p className="text-sm font-bold">Semester readiness</p><p className="mt-1 text-xs leading-5 text-slate-400">Your AI will track mastery, practice and revision.</p></div></div></div></div>
        </div>
      </section>
    </main>
  );
