...
export default function AuthNav() {
  ...
  if (!email) return <Link href="/login" className="fixed right-4 top-4 z-[100] inline-flex items-center gap-2 rounded-xl bg-slate-950 px-4 py-2.5 text-xs font-extrabold text-white shadow-lg transition hover:-translate-y-0.5 hover:shadow-xl"><LogIn size={15}/> Sign in</Link>;
